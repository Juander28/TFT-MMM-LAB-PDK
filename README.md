...
docs/                      PDK_GUIDE.md, extraction/, figures/, and pdf/ - the
                           generators for the three documents
...
Three, each in English and Spanish, generated by `docs/pdf/` and written to
...
```bash
cd docs/pdf
./make_figures.sh && python3 make_pdf.py && python3 make_sop.py && python3 make_model_report.py
```
